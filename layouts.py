...
from namerules import *
from instructions import *
from widgets import AppWidgets

tt = toolTips()
with open(os.path.join(os.getcwd(), '', '', 'instructions.html'),encoding='utf-8') as f:
...
class AppLayouts(AppWidgets):
    ...
    def start_ui(self):
        ...
        #@elaana remove spine order table choices from the start page
